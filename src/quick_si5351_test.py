...
clockgen.setupMultisynth( output=0, div=8, num=0, denom=1, pllsource="A", phase_delay=0.0)
...
clockgen.setupMultisynth( 1, divider, num2, denom2, pllsource="B", phase_delay=0.0)
...
clockgen.setupMultisynth(2, 100, 0, 1, pllsource="B", phase_delay=0.0)
