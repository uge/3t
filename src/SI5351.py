...
class SI5351:
    ...
    def begin( self):
        ...
        # disable OEB pin enable control
        self.write8(SI5351_REGISTER_9_OEB_PIN_ENABLE_CONTROL, 0xFF)
    ...
    def setupMultisynth( self, output, div, num, denom, pllsource, phase_delay=0, inverted=0, powerdown=0):
    ...
    def enableAllOutputs( self, enabled=True):
